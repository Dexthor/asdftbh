...
class Owner:
    ...
    async def _set(self, ctx):
        """Changes xcubed global settings."""
    ...
    async def join(self, invite_url: discord.Invite=None):
        ...
        if hasattr(self.bot.user, 'bot') and self.bot.user.bot is True:
            ...
            msg = ("xCubed is based on discord ext and built on python\n"
        "Its a mixture of mod tools, music bot and fun commands\n"
        "can be spammy sometimes since people like it so much :P\n"
        "Dm dex if you want it in your server")
