...
from .utils import checks1, formats #danny
...
class General:
    ...
    async def ping(self,ctx):
        ...
        #ms = (round(t2-t1)*1000)
        #s = ms / 1000
        #await self.bot.say ("took {}s to ping".format(s))
    ...
    async def tp(self,ctx):
        ...
        for i in range (1000):
            ...
            #await self.bot.say("nootnoot.net <3")

    @commands.command(pass_context=True)
    async def robohash(self,ctx,user:discord.User):
        """Robot pics based on your name."""
    ...
    async def shoot(self,ctx,*users:discord.User):
        ...
        for user in users:
            if user.id == self.bot.user.id:
                ...
                await self.bot.say('{} commited suicide!\n https://giphy.com/gifs/barney-stinson-neil-patrick-harris-suicide-jSxK33dwEMbkY'.format(ctx.message.author.name))
            else:
                if user:
    ...
    async def role(self, ctx, *, rolename):
        """Shows the name of Users containing a role"""
        server = ctx.message.server
        somerole = discord.utils.find(lambda r: r.name.lower() == rolename.lower(), ctx.message.server.roles)
        if somerole is not None and len([m for m in server.members if somerole in m.roles]) < 50:
            something = await self.bot.say("Retrieving Member Names. Just a sec")
            await asyncio.sleep(1) #taking time to retrieve the names
            server = ctx.message.server
            member = "Showing Members Containing the| **{0}** |Role, **{1}** Members found\n".format(rolename, len([m for m in server.members if somerole in m.roles]))
            member += "```diff\n+"
            member += " \n+".join(m.display_name for m in server.members if somerole in m.roles)
            member += "```"
            await self.bot.edit_message(something, member)
        elif len([m for m in server.members if somerole in m.roles]) > 50:
            awaiter = await self.bot.say("Retrieving Member Names. Just a sec")
            await asyncio.sleep(1)
            await self.bot.edit_message(awaiter, "Too Many Members Containing the| **{0}** |Role, **{1}** Members found\n".format(rolename,  len([m for m in server.members if somerole in m.roles])))
        else:
            await self.bot.say("``Unfortunately I couldn't find the role``")

    @commands.command(pass_context=True)
    async def shame(self,ctx,*users:discord.User):
        """Let the shame bells ring!"""
        await self.bot.say('🔔🔔🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​🔔🔔🔔\n🔔 ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔🔔🔔🔔 ​ ​ ​ ​ ​ ​🔔\n🔔🔔🔔 ​ ​ ​ ​ ​ ​ ​🔔🔔🔔 ​ ​ ​ ​ ​ ​ ​🔔🔔🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​🔔 ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔🔔🔔\n ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔\n🔔🔔🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​🔔 ​ ​ ​ ​ ​ ​ ​🔔🔔​🔔')

    @commands.command()
    async def char(self, *, characters: str):
    ...
    async def fancify(self,ctx,*,text:str):
        ...
        for letter in text:
            if 65 <= ord(letter) <= 90:
                output += chr(ord(letter) + 119951) #119951
            elif 97 <= ord(letter) <= 122:
                output += chr(ord(letter) + 119919) #119919
            elif letter == ' ':
                output += ' '
    ...
    async def avatar(self, ctx, *, user : discord.Member = None):
        """Shows the avatar about a member.

        This cannot be used in private messages. If you don't specify
        a member then the avatar returned will be yours.
        """
        ...
        pic = user.avatar_url
        entries = '{0} , {1} avatar:\n'.format(author.name, user)
        entries += pic
        await self.bot.say(entries)
